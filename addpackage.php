...
if (isset($_POST['add-hm'])) {
    ...
    echo $ins = "INSERT INTO `tbl_product_view`(`vid`, `event_package`, `category`, `price`, `capacity`, `about`, `event_photo_1`, `event_photo_2`, `event_photo_3`, `event_photo_4`, `event_photo_5`) VALUES ('$vendorId','$hfname','$hemail','$hphno','$hcapa','$habout','$img_name1','$img_name2','$img_name3','$img_name4','$img_name5')";
